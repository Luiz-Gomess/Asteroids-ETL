...
def trasform(data):
    ...
    try:
        ...
        #Renomeando colunas 
        df.rename(columns={
            "relative_velocity kilometers_per_second" : "relative_velocity_km/s",
            "miss_distance kilometers":"miss_distance_kilometers",
            "kilometers estimated_diameter_max": "estimated_diameter_kilometers"
            }, inplace=True)
    ...
    # Arredondando e convertendo valores numéricos.
